                        ...
                        <div className="flex items-start gap-2 sm:gap-3 mb-4 sm:mb-6">
                            ...
                            <div className="flex-1 flex flex-row sm:items-center gap-2">
                                <input
                                    ...
                                    className="flex-1 w-full bg-transparent border p-2 px-3 border-gray-300 focus:outline-none focus:border-accent rounded-full text-sm sm:text-base touch-manipulation"
                                    value={commentText}
