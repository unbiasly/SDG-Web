...
const page = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-t from-white to-accent/30 p-4">
        <div className="w-full max-w-md m-30 h-full relative">
            <div className="bg-white/60 h-full flex flex-col items-center justify-center rounded-lg shadow-lg overflow-hidden">
