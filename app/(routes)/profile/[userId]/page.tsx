...
export default function Page({
    ...
    const [activeProfileTab, setActiveProfileTab] = useState(() => {
        ...
        // Fetch user data by userId with retry logic
        const fetchUserById = async (id: string, retryCount = 0) => {
            const MAX_RETRIES = 3;
            ...
            try {
                ...
                // If we still have retries left and it might be a token issue, retry
        ...
        useEffect(() => {
            const fetchData = async () => {
                ...
                if (isSocietyProfile) getSocietyEvents();
            };
    
            fetchData();
            window.scrollTo(0, 0);
        }, [userId, isUpdated, isFollowingActive]);
        ...
        // Enhanced loading state that considers token refresh
